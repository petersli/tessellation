...
public:
    ...
    RGBA mixColor(RGBA canvasColor, float maskValue);
    int mixRGBChannel(float brushIntensity, float canvasIntensity, float maskValue, float alpha);
...
protected:
    ...
    // For setting up masks
    int squareMagnitude(int x, int y);
